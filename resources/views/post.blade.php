    ...
    <x-slot:nav>
        ...
        <x-slot:main>
            <div class="mx-auto h-full border-t border-gray-200 base:mx-5">
                <article class="my-7 w-full flex flex-col sm:grid sm:grid-cols-6 sm:gap-x-8 lg:gap-x-14">
                    ...
                    <div
                        ...
                        <div class="flex gap-x-2">
                            ...
                            <span class="px-4 py-1 border border-red-300 rounded-full text-xs font-medium text-red-300">
                                <a href="/search?tag={{ $post->tag->url }}">
                                    Updates
                                </a>
                            </span>
