<nav
     class="mx-auto pt-6 flex flex-wrap items-center justify-center gap-x-2 gap-y-2 base:justify-between xs:mx-6 base:px-5 base:py-6 base:flex-nowrap base:gap-y-0 lg:px-8">
