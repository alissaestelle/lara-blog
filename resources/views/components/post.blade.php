<article class="mx-auto flex flex-col items-start w-full max-w-80">
    ...
    <div class="mt-2 w-full flex items-center justify-between gap-x-4 text-xs xs:flex-col xs:gap-y-2 xs:items-start sm:flex-row sm:items-center">
    ...
    <div class="group relative">
        {{-- <h3
            ...
            --}}
            <h3 class="mt-2 text-gray-900 text-base font-medium leading-6 group-hover:text-gray-600 xs:mt-4 sm:mt-2 sm:text-lg">
                <a href="/posts/{{ $post->url }}">
                    {{ $post->title }}
                </a>
            </h3>
            ...
            <p class="mt-5 text-gray-600 text-xs line-clamp-3 leading-6 xs:leading-5 sm:leading-6 xs:mt-2 sm:mt-5 sm:text-sm">
                {{ $post->excerpt }}
            </p>
    </div>
</article>