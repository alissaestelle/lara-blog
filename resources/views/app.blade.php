                    ...
                    {{-- @dd($loop) --}}
                        <article class="flex max-w-80 flex-col items-start">
                            <div class="flex items-center gap-x-4 text-xs">
                                <time datetime="{{ $post->date }}" class="{{ $loop->first ? 'text-sky-700' : '' }} text-gray-500">
                            ...
                            <div class="group relative">
                                ...
                                <p class="{{ $loop->first ? 'text-fuchsia-800' : '' }} mt-5 line-clamp-3 text-sm leading-6 text-gray-600">
                                    {{ $post->excerpt }}
                                </p>
                            </div>
                        </article>
